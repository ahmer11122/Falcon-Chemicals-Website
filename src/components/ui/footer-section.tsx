                    ...
                    <div className="lg:col-span-3 space-y-6">
                        ...
                        <div className="space-y-5">
                            ...
                            <a
                                href="https://wa.me/923206377227"
                                target="_blank"
                                className="inline-flex items-center gap-2 mt-4 px-5 py-2.5 bg-teal-700 text-white text-xs font-semibold rounded-lg hover:bg-teal-600 hover:shadow-md hover:scale-[1.03] hover:-translate-y-0.5 transition-all duration-300"
                            >
                                Chat on WhatsApp
